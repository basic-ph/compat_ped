...
def main():
    ...
    print("""
  ######################################
  # CPED Development Environment Setup #
  ######################################

  This script will create your CPED dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your CPED project folder:
    [Arma 3 installation directory]\\{} => CPED project folder
    P:\\{}                              => CPED project folder
